...
export class HealthComponent extends Component {
  ...
  InitComponent() {
    this._RegisterHandler(
        'health.damage', (m: any) => this.OnDamage_(m));
    this._RegisterHandler(
        'stats.network', (m: any) => this.OnNetworkUpdate_(m));
    this._RegisterHandler(
        'health.add-experience', (m: any) => this.OnAddExperience_(m));
  ...
  OnAddExperience_(msg: { value: any; }) {
  ...
  OnNetworkUpdate_(msg: { value: any[]; }) {
